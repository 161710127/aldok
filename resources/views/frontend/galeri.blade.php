...
<head>
	...
	<link href="assets/taxx/03-services/css/styles.css" rel="stylesheet">

	<link href="assets/taxx/03-services/css/responsive.css" rel="stylesheet">
...
<body>
	...
	<div class="main-slider" style="background-image: url(assets/taxx/images/background.jpg);">
		<div class="display-table center-text">
			<div class="display-table-cell">
				<div class="slider-content">

					<h5 class="pre-heading"></h5>
					<h1><b>Galeri</b></h1>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 col-lg-4">
					<a class="icnbox active margin-b-50" href="single">
						<img src="{{asset('/assets/img/gambar/'.$data->gambar.'')}}" width="70" height="140">
						<h5 class="margin-tb-20"><b>{{$data->nama_gambar}}  </b></h5>
