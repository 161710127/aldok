			...
			<div class="panel panel-primary">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">Edit Data Table Gambar</h3>
				...
				<div class="panel-body">
					<form action="{{ route('gambar.update',$gambar->id) }}" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="nama_gambar" type="text" class="form-control{{ $errors->has('nama_gambar') ? ' is-invalid' : '' }}" name="nama_gambar" value="{{ $gambar->nama_gambar }}" >
