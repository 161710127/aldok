				...
				<div class="panel-body">
					<form action="{{ route('table_barang.update',$table_barang->id) }}" method="post">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<textarea id="ckeditor" type="text" class="ckeditor"{{ $errors->has('deskripsi') ? ' is-invalid' : '' }} name="deskripsi" value="{{ old('deskripsi') }}" required="">{{ $table_barang->deskripsi }}</textarea>
